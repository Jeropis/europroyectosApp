...
class CoordinadorProjectsRechazado extends StatefulWidget {
  @override
...
class _CoordinadorApprovedProjectsPageState
    extends State<CoordinadorProjectsRechazado> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            title: Text('Proyectos Rechazados'),
          ),
