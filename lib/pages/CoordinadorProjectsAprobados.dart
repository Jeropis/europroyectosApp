...
class CoordinadorProjectsAprobados extends StatefulWidget {
  @override
...
class _CoordinadorApprovedProjectsPageState
    extends State<CoordinadorProjectsAprobados> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            title: Text('Proyectos Aprobados'),
          ),
